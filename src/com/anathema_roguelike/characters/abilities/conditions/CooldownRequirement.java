...
public class CooldownRequirement extends AbilityRequirement {

	public CooldownRequirement(Ability ability) {
		super(ability);
	}
	...
	public String getRequirementUnmetMessage() {
		return Utils.getName(getAbility()) + " is on cooldown";
	}
