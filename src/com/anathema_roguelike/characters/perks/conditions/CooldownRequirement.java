...
public class CooldownRequirement extends PerkRequirement {

	public CooldownRequirement(Perk perk) {
		super(perk);
	}
	...
	public String getRequirementUnmetMessage() {
		return Utils.getName(getPerk()) + " is on cooldown";
	}
