...
public class CurrentHealth extends BoundedResource {
	...
	public void modify(Object source, int amount) {
		if(amount < 0) {
			int temphp = getCharacter().getModifiedStatScore(TemporaryHealth.class).intValue();
			
			getCharacter().modifyResource(source, TemporaryHealth.class, amount);
	...
	public int getMaximum() {
		return getCharacter().getModifiedStatScore(Health.class).intValue();
	}
