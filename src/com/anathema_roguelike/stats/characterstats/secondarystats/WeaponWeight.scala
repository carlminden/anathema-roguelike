...
class WeaponWeight(character: Character) extends SecondaryStat(character) {
  override def getAmount: Double = {
    getObject.getInventory.getSlot[PrimaryWeapon].getEquippedItem.get.getStatAmount[Weight]
  }
}