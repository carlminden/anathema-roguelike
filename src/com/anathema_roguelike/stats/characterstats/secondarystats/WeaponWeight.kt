...
class WeaponWeight(character: Character)// TODO Auto-generated constructor stub
    : SecondaryStat(character) {

    override fun getAmount(): Double {
        return getObject().inventory.getSlot<PrimaryWeapon>().equippedItem!!.getStatAmount(Weight::class.java)
    }
}
