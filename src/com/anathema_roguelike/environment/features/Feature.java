...
public abstract class Feature extends LocationProperty {
	...
	public Feature(VisualRepresentation representation, VisualRepresentation fogOfWarRepresentation,
		...
		super(representation, fogOfWarRepresentation, foreground, passable, opacity, damping);
	}
	...
	public Feature(VisualRepresentation representation, boolean foreground, boolean passable, double opacity, double damping) {
		super(representation, representation, foreground, passable, opacity, damping);
	}
	
	public Feature(VisualRepresentation representation, boolean foreground, boolean passable,
