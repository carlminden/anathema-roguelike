...
import com.anathema_roguelike.dungeon.Wall;
...
public class Cave extends Room {
	...
	public void place(DungeonGenerator generator) {
		...
		for(Door door : getDoors()) {
			...
			while(DungeonGenerator.validPoint(current) && map[current.getX()][current.getY()] instanceof Wall) {
				map[current.getX()][current.getY()] = new Floor(level, current);
