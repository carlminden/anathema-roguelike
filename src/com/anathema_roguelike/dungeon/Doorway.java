...
public class Doorway extends DungeonCell {
	...
	public Doorway(DungeonLevel level, Point point, int direction, boolean open) {
		super(level, point, getInitialRepresentation(direction), open);
		this.direction = direction;
		this.open = open;
	}
	
	public Doorway(DungeonLevel level, Point point, int direction) {
		super(level, point, getInitialRepresentation(direction), false);
		this.direction = direction;
		this.open = false;
	}
