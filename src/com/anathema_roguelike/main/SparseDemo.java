...
//                gridHeight * cellHeight * 0.5f - display.worldY(player.y));
    ...
    public static void main (String[] arg) {
        ...
        config.addIcon("data/Tentacle-16.png", Files.FileType.Classpath);
        config.addIcon("data/Tentacle-32.png", Files.FileType.Classpath);
        config.addIcon("data/Tentacle-128.png", Files.FileType.Classpath);
