...
package entities.items.miscellaneous
...
import com.anathema_roguelike.stats.itemstats.{ItemStat, Weight}
...
class Rock extends Item {
  ...
  override def getVisualRepresentation = new VisualRepresentation('*', Color.DARK_GRAY)
}