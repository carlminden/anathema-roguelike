...
class LongRange[T <: Targetable : TypeTag](constraints: TargetConstraint[T, Character]*) extends CircularRange[T](constraints:_*) {
  protected def getRadius(character: Character): Double = 10.0
}