...
class MediumRange[T <: Targetable : TypeTag] (val constraints: TargetConstraint[T, Character]*) extends CircularRange[T] (constraints:_*) {

  protected def getRadius (character: Character): Double = 5.0
}