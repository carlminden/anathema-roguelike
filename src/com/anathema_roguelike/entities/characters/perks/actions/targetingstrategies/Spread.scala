...
class Spread[TargetType <: Targetable : TypeTag : ClassTag, OriginType <: Targetable : TypeTag](
    targetType: Class[TargetType],
    radius: AdditiveCalculation,
    constraints: TargetConstraint[TargetType, OriginType]*)
  extends AreaOfEffect[TargetType, OriginType](constraints:_*) {

  override protected def getShape (origin: OriginType): Shape = {
