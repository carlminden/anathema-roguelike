...
class MeleeRange[T <: Targetable: TypeTag](constraints: TargetConstraint[T, Character]*) extends Range[T] (constraints:_*) {

  protected def getShape (character: Character): Shape = new Square (character, new FixedCalculation (1) )
}