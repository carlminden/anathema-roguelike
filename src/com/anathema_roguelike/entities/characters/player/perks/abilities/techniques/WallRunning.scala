...
class WallRunning extends Technique[Nothing] with Ability { //TODO Probably actually needs to be a PerkGroup that grants a cost and target modification, may need additional infrastructure
