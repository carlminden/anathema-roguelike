...
class BasicMovementAction(character: Character, location: HasLocation)
  extends MoveAction(character, new MovementEnergyCost(character), location,
    new StimulusCost[AttenuatedSound](character, () => 50.0, location,true)) {
}