 ...
 *******************************************************************************/
package com.anathema_roguelike.items.weaponproperties;

import com.anathema_roguelike.characters.Character;
import com.anathema_roguelike.characters.abilities.Ability;
import com.anathema_roguelike.items.Weapon;

public abstract class WeaponProperty extends Ability {
	
	private Weapon weapon;
	private Ability ability;
	
	public WeaponProperty(Weapon weapon, Ability ability) {
		super(weapon);
